...
public class VkShaderModule implements AutoCloseable {
	...
	public static final VkShaderModule INVALID_SHADER = new VkShaderModule(-1, ResourceLocation.withDefaultNamespace("invalid"), ShaderType.VERTEX);
	private final ResourceLocation id;
	private int shaderId;
	private final ShaderType type;

	public VkShaderModule(int i, ResourceLocation resourceLocation, ShaderType shaderType) {
		this.id = resourceLocation;
		this.shaderId = i;
		this.type = shaderType;
	}

	public static VkShaderModule compile(ResourceLocation resourceLocation, ShaderType shaderType, String string) throws ShaderManager.CompilationException {
		...
		if (GlStateManager.glGetShaderi(i, 35713) == 0) {
			...
			return new VkShaderModule(i, resourceLocation, shaderType);
		}
	}
